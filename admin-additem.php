 ...
 <html lang="en">
   ...
   <body>
     ...
     <div class="col-md-8">
       ...
       <h1 style="margin-top:100px;">Add Item</h1>
        <div class="row">
          <div class="col-sm-6">
            ...
            <button type="button" class="btn btn-primary btn-block signupbutton" onclick=myFunction()>Add Item</button>
          </div>
       </div>
     ...
     function myFunction(){
      ...
      $.post( "response/response_additem.php", { itemid: $("#itemid").val(), itemtype: $("#itemtype").val(),credit: $("#credit").val()})
      alert("Added");
