 ...
 <div class="row">
   <div class="col-sm-2">
    ...
    <ul class="nav nav-pills nav-stacked">
      ...
      <li role="presentation" class="active"><a href="#">History Package Top-up</a></li>
    </ul>
  ...
  <div class="col-sm-10" style="border-left: 5px solid;padding-left: 50px;padding-right: 20px;">
    <div class="show-area">
        ...
        <table class='table table-striped table-condensed'><thead><tr><th>Invoice No.</th><th>Timestamp</th><th>Package</th><th>Amount Paid</th><th>Amount credit point</th></tr></thead>
        <tbody>
...
<script type="text/javascript">
  ...
  $(document).ready( function(){
    $.post("response/response_historyPackage.php",
    { } ,
    function(data){
      ...
      if (data.status=="noHistory") {
          $(".table").html("<div class='alert alert-warning fade in' style='margin-top: 10px; font-family: 'Kanit',sans-serif; text-align:center;'>ไม่มีประวัติการซื้อแพคเกจ<br>สนใจซื้อแพคเกจ กรุณาติดต่อพนักงานที่หน้าเค้าท์เตอร์ค่ะ</div>");
      }
      else {
        for (var i = 0; i < data.length; i++)
        {
          $(".table").append(
            "<tr><td>" + data[i].invoiceNo + "</td>" +
